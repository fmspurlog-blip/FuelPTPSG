(async()=>{
  ...
  const pageVersion=params.get('v')||'78.5';
  const q='78.5-chart-calendar-'+String(pageVersion).replace(/[^a-zA-Z0-9._-]/g,'');
  ...
  setTimeout(()=>safeLoad('v785-chart-calendar.js?v='+q),1200);
