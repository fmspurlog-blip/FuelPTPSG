(async()=>{
  ...
  const q='78.3-final4-'+String(pageVersion).replace(/[^a-zA-Z0-9._-]/g,'');
  ...
  const bootUI=async()=>{for(const s of ['v741.js','v78-stable.js','v783-ui.js','v783-final.js'])await safeLoad(s+'?v='+q)};
